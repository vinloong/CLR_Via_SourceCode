...
public static class Program {
   ...
   private static class DynamicDemo {
      ...
      private sealed class StaticMembersDynamicWrapper : DynamicObject {
         private const BindingFlags c_bf = BindingFlags.Public | BindingFlags.Static;
         private readonly Type m_type;
         public StaticMembersDynamicWrapper(Type type) { m_type = type; }
         ...
         public override bool TryGetMember(GetMemberBinder binder, out object result) {
            ...
            if (members[0].MemberType == MemberTypes.Field)
               result = ((FieldInfo)members[0]).GetValue(null);
            else result = ((PropertyInfo)members[0]).GetValue(null, null);
            return true;
         }
         ...
         public override bool TrySetMember(SetMemberBinder binder, object value) {
            ...
            else ((PropertyInfo)members[0]).SetValue(null, value, null);
            return true;
         }
